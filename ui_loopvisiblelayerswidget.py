...
#
# Created: Fri Mar 16 22:13:10 2012
...
class Ui_LoopVisibleLayersWidget(object):
    def setupUi(self, LoopVisibleLayersWidget):
        ...
        LoopVisibleLayersWidget.resize(318, 181)
        ...
        self.btnStart = QtGui.QToolButton(self.frame)
        self.btnStart.setToolTip(_fromUtf8(""))
        self.btnStart.setStyleSheet(_fromUtf8("border: none; hover :{border: none}; pressed: {border: none}"))
        ...
        self.btnStop = QtGui.QToolButton(self.frame)
        self.btnStop.setEnabled(False)
        self.btnStop.setToolTip(_fromUtf8(""))
        self.btnStop.setStyleSheet(_fromUtf8("border: none; hover :{border: none}; pressed: {border: none}"))
        ...
        self.btnBack = QtGui.QToolButton(self.frame)
        self.btnBack.setEnabled(False)
        self.btnBack.setToolTip(_fromUtf8(""))
        self.btnBack.setStyleSheet(_fromUtf8("border: none; hover :{border: none}; pressed: {border: none}"))
        ...
        self.btnForward = QtGui.QToolButton(self.frame)
        self.btnForward.setEnabled(False)
        self.btnForward.setToolTip(_fromUtf8(""))
        self.btnForward.setStyleSheet(_fromUtf8("border: none; hover :{border: none}; pressed: {border: none}"))
        ...
        spacerItem3 = QtGui.QSpacerItem(5, 5, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.gridLayout.addWidget(self.lblStatus, 2, 1, 1, 1)
        spacerItem4 = QtGui.QSpacerItem(5, 5, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.gridLayout.addItem(spacerItem4, 3, 1, 1, 1)
        spacerItem5 = QtGui.QSpacerItem(5, 5, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
